        ...
        for i,df_dict in enumerate(data_dict):
            ...
            for measure in measures:
                ...
                for halo,cutout in enumerate(cutouts):
                    ...
                    cutout1 = gp.getkappa_imports(cutout,[nx,nx,dx,dx], cluster_mass, cluster_redshift)
...
pickle.dump(result,gzip.open('mf_results_fs/%s_halos_%s_cmb_noise_%s.pkl.gz'%(total_no_samples,cmb_power,noise_level),'w'))
