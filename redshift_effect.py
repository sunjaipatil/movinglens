...
pickle.dump(result,gzip.open('mf_results_websky_mass_1e14_1000clus_no_cmb_whitenoise.pkl.gz','w'))

end_time =time.time()
timeres ={}
timeres['time']  = (end_time - st_time)/60.
pickle.dump(timeres,gzip.open('mf_results_websky_mass_1e14_time_1000clus.pkl.gz','w'))
